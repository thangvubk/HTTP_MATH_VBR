...
public class HA_SDP_TayBanNhaAlgorithm extends AdaptationLogic {
    ...
    public HA_SDP_TayBanNhaAlgorithm(Buffer buffer, Manifest manifest) throws NumberFormatException, IOException {
    ...
    protected AdaptationDecision decideNextRequest() {
		...
		if (policy_3d[buffer_lvl][bw][q] != 1)
		{
			...
			selectedVersion = policy_3d[buffer_lvl][bw][q] - 2;
		}
